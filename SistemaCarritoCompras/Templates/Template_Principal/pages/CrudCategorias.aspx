<%@ Page Title="" Language="C#" MasterPageFile="~/IndexPage.Master" AutoEventWireup="true" CodeBehind="CrudCategorias.aspx.cs" Inherits="SistemaCarritoCompras.Templates.Template_Principal.pages.CrudCategorias" %>
                ...
                <main class="hoc container clear">
                    ...
                    <div style="width: 100%;">
                        <asp:GridView ID="grv_cliente" AutoGenerateColumns="False" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                <asp:BoundField DataField="cate_id" HeaderText="Codigo" />
                                <asp:BoundField DataField="cate_nombres" HeaderText="Nombres" />
                                <asp:TemplateField>
                                    <ItemTemplate>
