<%@ Page Title="" Language="C#" MasterPageFile="~/IndexPage.Master" AutoEventWireup="true" CodeBehind="CrudClientes.aspx.cs" Inherits="SistemaCarritoCompras.Templates.Template_Principal.pages.CrudClientes1" %>
                ...
                <main class="hoc container clear">
                    ...
                    <div class="content">
                        <div id="comments">
                            <div>
                                <div>
                                    <asp:HiddenField ID="hdf_clientesId" runat="server" />
                                </div>
                                ...
                                <div class="one_third">
                                    ...
                                    <asp:TextBox ID="txt_apellidos" runat="server" size="22"></asp:TextBox>
                                </div>
                                <div class="one_third">
                                    <label>Cedula <span>*</span></label>
                                    <asp:TextBox ID="txt_cedula" runat="server" size="22"></asp:TextBox>
                                </div>
                                <div class="one_third first">
                                    <label>Telefono <span>*</span></label>
                                    <asp:TextBox ID="txt_telefono" runat="server" size="22"></asp:TextBox>
                                </div>
                                <div class="one_third">
                                    <label>Dirección <span>*</span></label>
                                    <asp:TextBox ID="txt_direccion" runat="server" size="22"></asp:TextBox>
                                </div>
                                <div class="one_third">
                                    <label>Correo <span>*</span></label>
                                    <asp:TextBox ID="txt_correo" runat="server" size="22"></asp:TextBox>
                                </div>
                                <div>
                    ...
                    <div style="width: 100%;">
                        <asp:GridView ID="grv_cliente" AutoGenerateColumns="False" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="cli_apellidos" HeaderText="Apellido" />
